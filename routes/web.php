...
Route::POST('reject_request','HomeController@reject_request')->name('reject_request')->middleware('auth');
Route::POST('accept_request','HomeController@accept_request')->name('accept_request')->middleware('auth');
